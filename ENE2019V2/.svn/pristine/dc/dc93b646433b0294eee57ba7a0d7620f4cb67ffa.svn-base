...
public class Mod_IX_Fragment_003_02 extends DialogFragmentComponent {
	public interface Mod_IX_Fragment_0033_01Listener {
		void onFinishEditDialog(String inputText);
	}

	@FieldAnnotation(orderIndex = 1)
	public TextAreaField txtC903_OBS;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		getDialog().setTitle("Materia prima N\u00B0: " + detalle.c9p903_id);
	...
	private void inicio() {
		txtC903_OBS.requestFocus();
	}

	@Override
	protected View createUI() {
		buildFields();
		q0 = createQuestionSection(lblTitulo, txtC903_OBS);
	...
	protected void buildFields() {
		...
		txtC903_OBS = new TextAreaField(this.getActivity()).size(400, 750)
				.maxLength(3000);
		...
		btnCancelar.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Mod_IX_Fragment_003_02.this.dismiss();
			}
		});
		...
		Filtros.setFiltro(txtC903_OBS, Filtros.TIPO.ALFAN_U, 3000, null);
	}
