...
public class Mod_IV_Fragment_005 extends FragmentForm {
	...
	protected void buildFields() {
		...
		rgC4P417 = new RadioGroupOtherField(this.getActivity(),
				...
				R.string.c1c100m4p417_5, R.string.c1c100m4p417_6, R.string.c1c100m4p417_7).size(
				WRAP_CONTENT, 600).orientation(ORIENTATION.VERTICAL);
		txtC4P417_ESP = new TextField(this.getActivity(), false)
				.size(altoComponente, 450).hint(R.string.especifique)
				.soloTextoNumero();
		rgC4P417.agregarEspecifique(5, txtC4P417_ESP);
	...
	protected View createUI() {
		...
		q1 = createQuestionSection(R.string.c1c100m4p417, Gravity.START,
				rgC4P417);
	...
	public boolean grabar() {
		...
		if (rgC4P418.isTagSelected(2)) {
			// 2310
			// bean.c4p419_1 = bean.c4p419 = bean.c4p414_2 = bean.c4p420 =
			// bean.c4p421_1 = bean.c4p421_2 = bean.c4p421_3 = bean.c4p421_4 =
			// bean.c4p421_5 = null;
	...
	//	if (Util.getInt(bean.c4p404a_2) == 1) {
...
//			}
	...
	private void inicio() {
		...
		if (Util.getInt(bean.c4p404a_2) == 1) {
			Util.cleanAndLockView(this.getActivity(), rgC4P417);
			rgC4P418.requestFocus();
		}else{
			Util.lockView(this.getActivity(), false, rgC4P417);
