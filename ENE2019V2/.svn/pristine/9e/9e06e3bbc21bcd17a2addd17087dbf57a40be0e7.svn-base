...
import gob.inei.dnce.components.EntityEPE;
...
public class CCPP  extends Entity implements Exportable, Spinneable {
	...
	public String codccpp = null;
	public String nomccpp = null;
