...
//	public Caratula getEmpadronador(Integer id, String dni, String... secciones) {
//		return getDao().getEmpadronador(id, dni, secciones);
//	}
   ...
   public List<ModuloIII_det2> getModuloIII_det2(Moduloiii01 bean, SeccionCapitulo... secciones) { 
        return getDao().getModuloIII_det2(bean, secciones); 
    }
	
	public boolean saveOrUpdate(ModuloIII_det2 bean, SeccionCapitulo... secciones) throws java.sql.SQLException { 
        return getDao().saveOrUpdate(bean, secciones); 
    }	
	...
	public List<ModuloIII_det> getMODIII_det(Integer id) {
		return getDao().getMODIII_det(id);
	}
	...
	public List<UN> getUnidadesMedidaC4() {
		return getDao().getUnidadesMedidaC4();
	}
	...
	public boolean saveOrUpdate(Entity bean, SQLiteDatabase dbTX)
		...
		} else if (bean instanceof ModuloIII_det) {
			return getDao().saveOrUpdateCP((ModuloIII_det) bean, dbTX);
		...
		} else if (bean instanceof ModuloixDet04) {
			return getDao().saveOrUpdateCP((ModuloixDet04) bean, dbTX);
