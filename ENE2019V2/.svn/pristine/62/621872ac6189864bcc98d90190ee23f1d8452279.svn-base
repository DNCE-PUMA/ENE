...
//import gob.inei.ene2019v2.model.Personal;
...
//	private Personal personal = null;
	...
	private Caratula domiciliio = null;
	private List<Visita> visitas=null;
	public static Field[] fieldsP334 = null;
	private Map<Integer, Parameter> parameters = null;
	public static final String RUTA_BASE = Environment.getExternalStorageDirectory().getPath() + "/ENE2019/";
	...
	public static final int CONCAMBIOS = 1;
	public static final int NUEVO = 2;
	public static final int MODIFICADO = 3;
	public static final int FRACCIONADO = 4;
	public static final int FUSIONADO = 5;
	public static final int REPLANTEADO = 6;
	public static final int SIN_CAMBIOS = 7;
	public static final int INSERTADO_POR_ADM = 8;
	public static final int REUBICADO = 9;
	public static final int DESAPARECIDO = 10;
	public static final int ESTILO = R.style.btnStyleHeaderAzul;
	public static final int ESTILO_BOTON = R.style.btnStyleButtonSedapar2015;
	...
	public static Field[] fields400Sp = null;
	...
	public static final int HTST = 16;
	public static boolean ONLY_VISUALITATION = false;
	public static final int SEARCH = gob.inei.ene2019v2.R.drawable.green37;
	public static List<ActSecDivGrpClase> ACTIVIDADES;
	public static List<ActSecDivGrupo> RESOLUCIONES;
	public static final int ENCUESTADOR = 1;
	public static final String BOARGINGPASS = "DnCe0043593355";
	private Caratula plantilla = null;
	private Marco ruc = null;
	private App() {
...
//        logConfigurator.configure();
	...
	public Caratula getEmpresa() {
		return domiciliio;
	}

	public void setEmpresa(Caratula domicilio) {
		this.domiciliio = domicilio;
	}
	...
	public void setPlantilla(Caratula plantilla) {
		this.plantilla = plantilla;
	}
	
	public Caratula getPlantilla(){
		return plantilla;
	}
