...
public class Mod_IV_Fragment_020 extends FragmentForm {
	...
	public CheckBoxField chbC4P467_1;
	@FieldAnnotation(orderIndex = 2)
	public CheckBoxField chbC4P467_2;
	@FieldAnnotation(orderIndex = 3)
	public CheckBoxField chbC4P467_3;
	@FieldAnnotation(orderIndex = 4)
	public CheckBoxField chbC4P467_4;
	@FieldAnnotation(orderIndex = 5)
	public CheckBoxField chbC4P467_5;
	@FieldAnnotation(orderIndex = 6)
	public CheckBoxField chbC4P467_6;
	@FieldAnnotation(orderIndex = 7)
	public CheckBoxField chbC4P467_7;
	@FieldAnnotation(orderIndex = 8)
	public CheckBoxField chbC4P467_8;
	...
	protected void buildFields() {
		...
		chbC4P467_1 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_1, "1:0").size(WRAP_CONTENT, 600);
		chbC4P467_2 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_2, "1:0").size(WRAP_CONTENT, 600);
		chbC4P467_3 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_3, "1:0").size(WRAP_CONTENT, 600);
		chbC4P467_4 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_4, "1:0").size(WRAP_CONTENT, 600);
		chbC4P467_5 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_5, "1:0").size(WRAP_CONTENT, 600);
		chbC4P467_6 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_6, "1:0").size(WRAP_CONTENT, 600);
		chbC4P467_7 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_7, "1:0").size(WRAP_CONTENT, 600);
		chbC4P467_8 = new CheckBoxField(this.getActivity(),
				R.string.c1c100m4p467_8, "1:0").size(WRAP_CONTENT, 600);
	...
	protected View createUI() {
		...
		q1 = createQuestionSection(R.string.c1c100m4p467, chbC4P467_1,
				chbC4P467_2, chbC4P467_3, chbC4P467_4, chbC4P467_5);
