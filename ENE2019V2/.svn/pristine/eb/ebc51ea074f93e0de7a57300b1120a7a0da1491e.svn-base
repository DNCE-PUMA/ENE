...
public class Caratula_Fragment_007 extends FragmentForm {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		enlazarCajas();
		listening();
		seccionesCargado = new SeccionCapitulo[] { new SeccionCapitulo(-1, -1,-1, "ID",
				"C1P101A_1 ", "C1P101A_8ESP", "C1P101B",
				"C1P101B_1", "C1P101B_2", "C1P101B_3", "C1P101B_4",
				"C1P101B_5", "C1P101B_6", "C1P101B_7", "C1P101B_8",
				"C1P101B_9", "C1P101B_10", "C1P101B_11", "C1P101B_11ESP",
				"C1P102", "C1P103", "C1P103_ESP", "C1P104", "C1P105",
				"C1P106_1", "C1P106_2", "C1P106_3", "C1P106_4", "C1P106_5",
				"C1P106_6", "C1P106_7", "C1P106_8", "C1P106_10",
				"C1P106_10ESP" 
				) };
		return rootView;
	}
	...
	protected void buildFields() {
		...
		rgP30 = new RadioGroupOtherField(this.getActivity(),
				...
				.orientation(ORIENTATION.VERTICAL).callback("P30");
		...
		chbP31_ELMISMO = new CheckBoxField(this.getActivity(),
				R.string.c1c100P31, "1:0").size(WRAP_CONTENT, 350).callback("P30");
	...
	public boolean grabar() {
		...
		if ((Util.getInt(bean.p29_a) == 2 &&  Util.getInt(bean.p25) < 3)|| ( Util.getInt(bean.p25) > 2)){
			extras = new String[] { "C1P101A_1 ", "C1P101A_8ESP", "C1P101B",
					"C1P101B_1", "C1P101B_2", "C1P101B_3", "C1P101B_4",
					"C1P101B_5", "C1P101B_6", "C1P101B_7", "C1P101B_8",
					"C1P101B_9", "C1P101B_10", "C1P101B_11", "C1P101B_11ESP",
					"C1P102", "C1P103", "C1P103_ESP", "C1P104", "C1P105",
		...
		try {	
			bean1.c1p101a_1 = bean1.c1p101b = bean1.c1p101b_1 = bean1.c1p101b_2 = bean1.c1p101b_3 = bean1.c1p101b_4 = bean1.c1p101b_5 = bean1.c1p101b_6 = bean1.c1p101b_7 = bean1.c1p101b_8 = bean1.c1p101b_9 = bean1.c1p101b_10 = bean1.c1p101b_11 = bean1.c1p102 = bean1.c1p103 = bean1.c1p104 = bean1.c1p105 = bean1.c1p106_1 = bean1.c1p106_2 = bean1.c1p106_3 = bean1.c1p106_4 = bean1.c1p106_5 = bean1.c1p106_6 = bean1.c1p106_7 = bean1.c1p106_8 = bean1.c1p106_9 = null;			
			bean1.c1p101a_8esp =bean1.c1p101b_11esp=bean1.c1p103_esp=bean1.c1p106_esp=null;
		
			if (!getCuestionarioService()
					.saveOrUpdate(bean1, getSecCap2( false, extras))) {
	...
	private boolean validar() {
		...
		if (chbP32_EMAIL_NO.isChecked() && chbP33_CEL_NO.isChecked()
			...
			mensaje = "Error: Debe tener algún número para contactar o correo";
			view = chbP32_EMAIL_NO;
			return !(error = true);
		}
		
		if(rgP30.isTagSelected(2) || rgP30.isTagSelected(4) || rgP30.isTagSelected(5)  ){
			if ((txtP31_APAT.getText().toString().equals( Util.getText(bean.p26_apat)))
				...
				mensaje = "Error: Si el nombre del gerente y el informante son iguales no debe marcar la opción cargo como 2 ,4 o 5";
				view = rgP30;
				return !(error = true);
			}
		}
	...
	public void cargarDatos() {
		...
		bean1 = getCuestionarioService().getModuloi(
	...
	private void inicio() {
		...
		if (rgP30.isTagSelected(1)) {
			cleanAndLockView(txtP31_NOMB, txtP31_APAT, txtP31_AMAT, chbP31_ELMISMO);
		//	lockView(false, chbP31_ELMISMO);
		} else if (rgP30.isTagSelected(3)) {
			lockView(false, chbP31_ELMISMO);
			if (chbP31_ELMISMO.isChecked()) {
				lockView(false, txtP31_NOMB, txtP31_APAT, txtP31_AMAT);
				txtP31_NOMB.setText(bean.p26_nomb);
				txtP31_NOMB.readOnly();
				txtP31_APAT.setText(bean.p26_apat);
				txtP31_APAT.readOnly();
				txtP31_AMAT.setText(bean.p26_amat);
				txtP31_AMAT.readOnly();
			}else{
//				txtP31_NOMB.readOnly(false);
//				txtP31_NOMB.setText("");
//				txtP31_APAT.readOnly(false);
//				txtP31_APAT.setText("");
//				txtP31_AMAT.readOnly(false);
//				txtP31_AMAT.setText("");
//				txtP31_NOMB.requestFocus();
			}
		} else if (rgP30.isTagSelected(2) || rgP30.isTagSelected(4)|| rgP30.isTagSelected(5)) {
			txtP31_NOMB.readOnly(false);
		//	txtP31_NOMB.setText("");
			txtP31_APAT.readOnly(false);
		//	txtP31_APAT.setText("");
		...
		//	txtP31_AMAT.setText("");
			txtP31_NOMB.requestFocus();
			lockView(false, txtP31_NOMB, txtP31_APAT, txtP31_AMAT);
			cleanAndLockView(chbP31_ELMISMO);
		}
