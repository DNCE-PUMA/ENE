...
import gob.inei.ene2019v2.controller.Inicializacion;
import gob.inei.ene2019v2.service.Service;
...
//			version +=  " " + App.getInstance().getVersion(this);
			version +=  " v" + App.getInstance().getVersion(this) ;//  + " Verif";
		...
		// TODO QUITAR
		txtUSUARIO.setText("ENC001");
		txtCLAVE.setText("3670");
